    ...
    <div class="container">
        <div class="row">
            ...
            <article class="col-lg-8 col-md-8 col-sm-8">
                <h2 class="marg">Контактная форма</h2>
                ...
                <div class="holder">
                    <div class="form-div-1 clearfix">
                        <label class="name">
                            ...
                            <span class="_placeholder" style="left: 0px; top: 0px; width: 210px; height: 44px;">* Имя:</span>
                ...
                <div class="form-div-4 clearfix">
                    <label class="message">
                        ...
                        <span class="_placeholder" style="left: 0px; top: 0px; width: 740px; height: 282px;">* Сообщение:</span>
                ...
                <div class="btns">
                    ...
                    <button type="submit" class="btn-default btn3">Отправить <span class="fa fa-angle-double-right"></span></button>
